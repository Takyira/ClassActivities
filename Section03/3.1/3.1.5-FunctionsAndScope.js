...
console.log(total); // We expect an error will be thrown because total is initialized in a child scope and therefore not accessible form the global scope.
...
function parentAndChildScope() {
  ...
  console.log("Parent Scope, Child Variable:", childVariable); //this scope will not print because childVariable is not accessible from the scope of this function because it is initialized in the scope of the "childScope" function
}
